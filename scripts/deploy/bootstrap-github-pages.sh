...
for repo in seanpcallahan.net 3ninjallc.com; do
...
echo "  seanpcallahan.net repo → Settings → Pages → custom domain: seanpcallahan.net"
echo "  3ninjallc.com repo     → Settings → Pages → custom domain: 3ninjallc.com"
echo ""
echo "=== 7. DNS cutover ==="
